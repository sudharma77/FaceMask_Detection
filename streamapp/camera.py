...
mydb = mysql.connector.connect(host= 'localhost', user= 'root' , passwd= '1234', database = 'froyo', auth_plugin='mysql_native_password')
...
class MaskDetect(object):
	...
	def get_frame(self):
		...
		mycursor.execute("INSERT INTO predator (mask,nomask) VALUES(%s,%s)", (maskper, nomaskper))
		mydb.commit()
		return jpeg.tobytes()
